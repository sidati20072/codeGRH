...
export class PretsComponent implements OnInit {
  ...
  calcul() {
    ...
    if (!this.item.valeur_totale) return ;
    if (this.item.valeur_totale && this.item.retenu_mensuel) {
      this.item.mois = this.item.valeur_totale / this.item.retenu_mensuel;
    }
    if (this.item.valeur && this.item.mois) {
      this.item.retenu_mensuel = this.item.valeur_totale / this.item.mois;
    }
  }
}
